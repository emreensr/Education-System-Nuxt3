...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_nuxt_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="font-normal text-sm text-white"${_scopeId}>Profilimi G\xF6r\xFCnt\xFCle</span>`);
          } else {
            return [
              ...
              createVNode("span", { class: "font-normal text-sm text-white" }, "Profilimi G\xF6r\xFCnt\xFCle")
            ];
          }
        }),
        _: 1
      ...
      _push(`</li><button class="w-full mt-10 bg-[#EC5252] rounded-full py-1.5 text-white">\xC7\u0131k\u0131\u015F Yap</button></ul></div><main class="min-h-screen col-span-12 lg:col-span-9 bg-white border-l">`);
...
//# sourceMappingURL=profile-eeb4e8dd.mjs.map
