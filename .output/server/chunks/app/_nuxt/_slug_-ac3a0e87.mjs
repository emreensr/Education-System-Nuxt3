...
import { _ as __nuxt_component_1 } from './Swiper-01a7ff46.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><div class="flex justify-center items-center"><div class="font-semibold text-center mx-4"><button type="button" class="flex items-center gap-3 inline-block px-6 py-3 mt-4 mb-0 ml-auto font-bold text-white align-middle transition-all border-0 rounded-lg cursor-pointer hover:scale-[1.02] active:opacity-[.85] hover:shadow-xs bg-gradient-to-tl from-[#141727] to-[#3a416f] leading-pro text-sm ease-in tracking-tight shadow-md bg-150 bg-x-25"> Detayl\u0131 G\xF6r </button></div></div>`);
      if (unref(showModal)) {
...
//# sourceMappingURL=_slug_-ac3a0e87.mjs.map
