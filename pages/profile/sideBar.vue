    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:my-3 max-w-8xl container mx-auto">
		<div class="py-10 bg-white shadow-md p-5 col-span-12 lg:col-span-3 h-screen">
			...
			<ul>
				...
				<li class="flex space-x-2 mt-6 cursor-pointer hover:text-[#EC5252] duration-150">
                ...
                <li class="flex space-x-2 mt-6 cursor-pointer hover:text-[#EC5252] duration-150">
					...
					<span class="font-normal">Ayarlar</span>
				</li>
				<button class="w-full mt-10 bg-[#EC5252] rounded-full py-1.5 text-white">Çıkış Yap</button>
			</ul>
		</div>
        <main class="min-h-screen col-span-9 bg-white border-l">
            <nav class="flex items-center justify-between px-10 bg-white py-6 border-b">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <p class="hidden md:block">Emre Ensar</p>
                </div>
            </nav>
            <div class="mx-6">
                <h1 class="my-6 text-3xl">Genel Bilgiler</h1>
