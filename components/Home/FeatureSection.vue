        ...
        <div class="lg:max-w-lg">
          ...
          <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
            <div class="relative pl-9">
              ...
              <dd class="inline">Öğrenciler için tasarlanan bu platformda, sizlere eğitmenlerimiz tarafından sunulan çeşitli derslere erişme imkanı sağlıyoruz. İlgi alanlarınıza ve öğrenmek istediğiniz konulara göre filtreleme yapabilir, derslere katılabilir ve bilgi birikiminizi genişletebilirsiniz.
                Ayrıca, diğer öğrencilerle iletişim kurarak deneyimlerinizi paylaşabilir ve birlikte öğrenme ortamında aktif olabilirsiniz.</dd>
            </div>
            <div class="relative pl-9">
              <dt class="inline font-semibold text-gray-900">
                <svg class="absolute left-1 top-1 h-5 w-5 text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              ...
              <dd class="inline">Eğitmenler için bu platform, bilgi ve uzmanlıklarınızı paylaşmanız için harika bir fırsat sunuyor. Kendi derslerinizi oluşturabilir, öğrencilerinizle etkileşime geçebilir ve onların öğrenme yolculuklarında rehberlik edebilirsiniz. Eğitim materyallerinizi yükleyebilir, ödevler verebilir ve öğrencilerinizin ilerlemesini takip edebilirsiniz.
                Kendi öğrenme topluluğunuzu oluşturmak ve öğrencilerinizle gerçek bir bağ kurmak için buradayız!</dd>
            </div>
            <div class="relative pl-9">
              <dt class="inline font-semibold text-gray-900">
                <svg class="absolute left-1 top-1 h-5 w-5 text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              ...
              <dd class="inline">Merhaba! Öğrenciler ve eğitmenler için harika bir platforma hoş geldiniz. Burada sizlere öğrenme ve öğretme deneyiminizi geliştirmek için bir araya gelme fırsatı sunuyoruz. Yeni bilgiler edinmek, dersler paylaşmak ve yeteneklerinizi keşfetmek için buradayız.
                 Hadi, kaydolun ve yeni bağlantılar kurmaya başlayın!</dd>
            </div>
          </dl>
        </div>
      </div>
...
<div class="bg-white py-8">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <div class="mx-auto mt-16 max-w-7xl sm:mt-20 lg:mt-24 lg:max-w-6xl">
...
<div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 mt-20 rounded-xl mb-40">
