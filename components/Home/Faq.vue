<template>
  <div class="mx-auto max-w-6xl border-b border-gray-200 my-8 text-center">
    <p class="my-8 text-3xl font-bold text-gray-900 lg:text-4xl">
      Sıkça Sorulan Sorular
    </p>
    <ul class="flex -mb-px text-md font-medium text-center text-[#525258]">
  ...
  <div v-if="activeTab === 0" class="mx-6 lg:mb-24 mb-12">
    <div class="mx-auto max-w-6xl grid lg:grid-cols-4 gap-10">
      ...
      <div class="col-span-3 space-y-8">
        ...
        >
          <div class="border p-6 rounded-[45px] space-y-5">
            <div
            ...
            >
              ...
              <h1 :class="['text-3xl', { 'text-red-500': item.open }]">
                <Icon
                  :class="[
                    'transition-transform', // Geçiş efekti için sınıf
                    'transform', // Dönüşüm sınıfını ekliyoruz
                    'duration-300',
                    { 'rotate-0': item.open, '-rotate-180': !item.open }, // Dönüşüm sınıfları
                  ]"
                  name="uil:angle-up"
                  size="30"
                />
  ...
  <div v-if="activeTab === 1" class="mx-6 lg:my-12">
    <div class="mx-auto max-w-6xl grid lg:grid-cols-4 gap-10">
      <div class="col-span-1">
        <h1 class="font-bold lg:text-4xl text-2xl">Abonelik & Paketler</h1>
      </div>
      <div class="col-span-3 space-y-8">
        <div
          v-for="(item, index) in accordionItems"
