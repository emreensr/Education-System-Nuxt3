...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span class="font-normal text-[#3F4254]">Müsait Günlerin</span></li><li class="flex space-x-2 mt-6 cursor-pointer hover:text-[#EC5252] duration-150">`);
      _push(ssrRenderComponent(_component_Icon, {
...
//# sourceMappingURL=sideBar-7dd0c5ce.js.map
