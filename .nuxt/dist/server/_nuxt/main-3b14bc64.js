import { _ as __nuxt_component_0$2 } from "./nuxt-link-26e5a74c.js";
import { inject, unref, mergeProps, withCtx, createTextVNode, toDisplayString, openBlock, createBlock, createVNode, useSSRContext, ref, provide } from "vue";
import "hookable";
import { e as useState, u as useHead } from "../server.mjs";
import "destr";
import "devalue";
import "klona";
...
import __nuxt_component_0$3 from "./Icon-55c87a06.js";
...
const _imports_0$1 = "" + __publicAssetsURL("headLogo.png");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><footer class="bg-[#010C20] shadow dark:bg-gray-900"><div class="mx-auto max-w-7xl"><div class="grid grid-cols-1 lg:grid-cols-4 lg:gap-10 gap-12 lg:py-12 py-8"><div class="col-span-1 lg:ml-0 ml-3"><img class="w-40 text-white" id="logoMain"${ssrRenderAttr("src", _imports_0)} alt="Pizzeria Minigolf"><p class="text-[#b0b0b8] py-5 lg:ml-0 ml-3"> Sizi alanında uzman en yakın öğretmene ulaştırarak en verimli şekilde özel ders almanızı sağlar. </p></div><div class="col-span-1 lg:ml-0 ml-3"><h1 class="text-white text-xl font-semibold">Kullanıcı İşlemleri</h1><div class="flex space-x-20"><ul class="pl-4 mt-6 text-[#b0b0b8] space-y-3"><li>Kullanım Şartları</li><li>Gizlilik Politikamız</li><li>İade Şartlarımız</li><li>Mesafeli Satış Sözleşmemiz</li></ul></div></div><div class="col-span-1 lg:ml-0 ml-3"><h1 class="text-white text-xl font-semibold">Özel Ders İşlemleri</h1><div class="flex space-x-20"><ul class="pl-4 mt-6 text-[#b0b0b8] space-y-3"><li>Özel Ders Talepleri</li><li>Özel Ders Verme</li><li>Özel Ders Alma</li><li>Online Ders</li></ul></div></div><div class="col-span-1 lg:ml-0 ml-3"><h1 class="text-white text-xl font-semibold">Hesap İşlemleri</h1><div class="flex space-x-20"><ul class="pl-4 mt-6 text-[#b0b0b8] space-y-3"><li>Giriş Yap</li><li>Kayıt Ol</li></ul></div></div></div><hr class="border border-solid border-gray-800"><div class="lg:flex justify-between items-center pt-5 pb-8"><div class="text-[#b0b0b8] lg:ml-0 ml-3"><h1> © 2023 <span class="text-white">Egitiva</span> Tüm hakları saklıdır. </h1></div><div><ul class="flex text-white gap-2 lg:ml-0 ml-3 lg:mt-0 mt-3"><li><div class="flex lg:col-span-2 h-10 w-10 rounded-md bg-[#ffffff1a] items-center justify-center">`);
...
//# sourceMappingURL=main-3b14bc64.js.map
