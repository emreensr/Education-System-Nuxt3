...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><nav class="flex items-center justify-between px-6 bg-white py-6 border-b"><div class="flex flex-col gap-2"><h1 class="text-2xl font-semibold">İlanlarım</h1><p class="text-gray-600">Buradan tüm ilanlarını yönetebilir ve yeni bir ilan oluşturabilirsin.</p></div>`);
...
//# sourceMappingURL=my-adverts-f4590d16.js.map
