  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(activeTab) === 1) {
        _push(`<div class="mx-6"><div class="w-full space-y-3 md:space-y-0 md:space-x-4 mt-6"><form><div class="space-y-12"><div class="pb-4"><h2 class="text-base font-semibold leading-7 text-gray-900"> Kişisel Bilgiler </h2><p class="mt-1 text-sm leading-6 text-gray-600"> Buradan kişisel bilgilerinizi girebilirsiniz. </p><div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-6 lg:grid-cols-6"><div class="sm:col-span-3"><label for="country" class="block text-sm font-medium leading-6 text-gray-900">Üniversite</label><div class="mt-2"><select id="country" name="country" class="p-2.5 bg-gray-50 border border-gray-300 text-gray-900 focus:shadow-[0_0_0_2px_#e5e7eb] text-[.875rem] mt-2 leading-5.6 ease block w-full appearance-none rounded-md bg-clip-padding p-2.5 font-normal outline-none transition-all placeholder:text-grey-500 focus:border-gray-400 focus:outline-none choices__input"><option disabled value="">Üniversite Seçiniz</option><!--[-->`);
...
//# sourceMappingURL=index-ee13b17b.js.map
